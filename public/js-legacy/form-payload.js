...
export function buildPayload(grids) {
  ...
  const i_t = normalizeClockTime((_document$getElementB46 = document.getElementById("i_t")) === null || _document$getElementB46 === void 0 ? void 0 : _document$getElementB46.value);
