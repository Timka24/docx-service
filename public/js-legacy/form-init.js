...
const IVL_DEVICE_OPTIONS = ['3/30 -"Медпром"', '3/30А -"Медпром"', '"РИТМ" 100 "ТМТ"', 'WEINMANN MEDUMAT', 'CareFusion LTV-1200'];
const DEFIB_MODEL_OPTIONS = [{
  label: "Ручные",
  values: ["AXION ДКИ-Н-11", "BeneHeart D3"]
}, {
  label: "Автоматические",
  values: ["ZOL AED Plus", "LifePak", "Comen", "Corpuls3", "Mindray BeneHeart", 'ДКИ-Н-11 "Аксион"']
}];
...
function initUxSections() {
  const sections = [{
    ...
    startFieldId: "chronoToggleGroup",
...
function syncSectionVisibility() {
  ...
  visibleWrappers.filter(wrapper => !wrapper.classList.contains("is-collapsed")).slice(2).forEach(wrapper => wrapper.classList.add("is-collapsed"));
}
...
async function refreshArchiveStatus(archiveId) {
  ...
  try {
    ...
    if (!resp.ok) {
      var _data2;
      const errText = ((_data2 = data) === null || _data2 === void 0 ? void 0 : _data2.error) || `HTTP ${resp.status}`;
      setGenerateStatus({
...
(_document$getElementB26 = document.getElementById("kvNumber")) === null || _document$getElementB26 === void 0 || _document$getElementB26.addEventListener("blur", trySuggestLoadByKv);
(_document$getElementB27 = document.getElementById("kvPrefix")) === null || _document$getElementB27 === void 0 || _document$getElementB27.addEventListener("blur", trySuggestLoadByKv);
(_document$getElementB28 = document.getElementById("nowDate")) === null || _document$getElementB28 === void 0 ? void 0 : _document$getElementB28.addEventListener("change", () => {
  var _document$getElementB29;
  const previousPrefix = ((_document$getElementB29 = document.getElementById("kvPrefix")) === null || _document$getElementB29 === void 0 ? void 0 : _document$getElementB29.value) || "";
