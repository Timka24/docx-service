export function createEnergyRow(cfg) {
  ...
  function init() {
    ...
    setBtn === null || setBtn === void 0 || setBtn.addEventListener("click", () => useInputValue());
    ...
    (_document$getElementB = document.getElementById(cfg.modePaintBtnId)) === null || _document$getElementB === void 0 || _document$getElementB.addEventListener("click", () => {
      mode = "paint";
      rangeStart = null;
      clearPreview();
      setModeBtn("paint");
    ...
    (_document$getElementB2 = document.getElementById(cfg.modeRangeBtnId)) === null || _document$getElementB2 === void 0 || _document$getElementB2.addEventListener("click", () => {
      mode = "range";
      rangeStart = null;
      clearPreview();
      setModeBtn("range");
